...
class RecipeShopMenu {
    constructor(recipes) {
        this.recipes = recipes;

        this.listWindow = new ListWindow(10, 40, 200, 220, recipes.map(recipe => recipe.name));
    ...
    update() {
        ...
        this.ingredientsWindow.text = recipe.ingredients.reduce((text, ingredient) => text + "\n" + ingredient, "Ingredients:\n");
